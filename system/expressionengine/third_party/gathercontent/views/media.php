<div class="gc_container gc_cf">
	...
	<div id="gc_media">
		...
		<label><?php echo lang('gathercontent_item') ?> <span id="gc_item_title" title="<?php echo $original_title ?>"><?php echo $item_title ?></span><img src="<?php echo $_theme_url ?>images/ajax-loader-grey.gif" alt="" /></label>
		...
		<div class="gc_center">
			<a href="<?php ee()->gc_functions->url('item_import') ?>" class="gc_blue_link"><?php echo lang('gathercontent_cancel') ?></a>
		</div>
	</div>
</div>
